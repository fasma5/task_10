...
const filterFruits = () => {
  fruits.filter((item) => {
    ...
    const minWeightInput = document.getElementById('minWeightInput'); // нижняя граница weight
    const maxWeightInput = document.getElementById('maxWeightInput'); // верхняя граница weight
